...
void _showPasswordDialog(BuildContext context) {
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return StatefulBuilder( // Para poder usar setState dentro del diálogo
        builder: (context, setState) {
          return AlertDialog(
            ...
            content: Column(
              ...
              children: [
                TextField(
                  controller: passwordController, // Usa el controlador para obtener el valor del input
                  ...
                  decoration: InputDecoration(
                    ...
                    errorText: errorMessage, // Muestra el mensaje de error si no es nulo
                  ),
                ),
              ],
            ),
            actions: <Widget>[
              ...
              TextButton(
                ...
                onPressed: () {
                  ...
                  password = passwordController.text; // Obtiene el valor ingresado
